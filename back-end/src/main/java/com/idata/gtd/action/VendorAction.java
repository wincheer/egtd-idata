...
public class VendorAction {
	...
	public List<VendorEmployee> selectVendorEmpList(@RequestBody Vendor vendor) {

		return vendorService.selectVendorEmpList(vendor.getId());
	};
	
	@RequestMapping(value = "/updateVendorEmp", method = RequestMethod.POST)
	public int updateVendorEmp(@RequestBody VendorEmployee vendorEmp) {
	...
	public int delVendorEmp(@RequestBody VendorEmployee vendorEmp) {
